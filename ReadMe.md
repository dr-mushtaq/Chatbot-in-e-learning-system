...
|**Development of Chatbot System to decrease workload in e-learning system**| [![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Chatbot-in-e-learning-system/blob/main/Model_Training_Samman_V1.ipynb) | LSTM,ANN,RF,BERT|[intents_Samman_V1](https://github.com/dr-mushtaq/Chatbot-in-e-learning-system/blob/main/intents_Samman_V1.json)|Dr.Mushtaq|3-Augest-2023|InProgress|
